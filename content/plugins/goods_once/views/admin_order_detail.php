...
$secrets = [];
$secretTotal = 0;
$secretSql = "SELECT s.content, u.create_time AS deliver_time
...
$countRow = $db->once_fetch_array("SELECT COUNT(*) AS total FROM {$db_prefix}stock_usage WHERE order_list_id = {$child_order['id']}");
...
<div class="once-order-detail">
    <div class="once-header">
        <div class="once-header-top">
            <div class="once-header-title">
    ...
    <div class="once-card">
        <div class="once-card-header">
            <i class="layui-icon layui-icon-user"></i>
            用户 & 订单信息
        </div>
        <div class="once-card-body">
            <div class="info-grid">
                <div class="info-item">
                    <span>用户昵称</span>
    ...
    <div class="deliver-section">
        <div class="deliver-header">
            ...
            <div class="deliver-actions">
                <button class="action-btn" id="copyAllBtn">复制全部（最多10条）</button>
                <button class="action-btn primary" id="downloadBtn">下载全部卡密</button>
            </div>
            <?php endif; ?>
        </div>
