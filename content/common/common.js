...
jQuery(document).ready(function(e) {
    var c = e("#nav-box").attr("data-type");
    e(".nav>li").each(function() {
        try {
            ...
            if ("index" == c) {
                ...
                var V = e("#nav-box").attr("data-infoid");
                if (V != null) {
                    var a = V.split(" ");
                    for (var ad = 0; ad < a.length; ad++) {
                        if (d == "navbar-category-" + a[ad]) {
                            e("#navbar-category-" + a[ad] + "").addClass("active")
                        }
                    }
                }
            } else if ("article" == c) {
                ...
                if (V != null) {
                    if (d == "navbar-page-" + V) {
                        e("#navbar-page-" + V + "").addClass("active")
                    }
                }
            } else if ("tag" == c) {
                var V = e("#nav-box").attr("data-infoid");
                if (V != null) {
                    if (d == "navbar-tag-" + V) {
                        e("#navbar-tag-" + V + "").addClass("active")
                    }
                }
            }
        } catch(e) {}
    });
    e("#nav-box").delegate("a", "click",
        function() {
            e(".nav>li").each(function() {
    ...
    if (typeof Object.create !== "function") {
        Object.create = function(e, c) {
            ...
            if (typeof c != "undefined") throw new Error("This browser's implementation of Object.create is a shim and doesn't support a second argument.");
            function d() {}
            d.prototype = e;
            return new d
        }
    ...
    var cQ = function(e) {
        if (!bR(e)) return true;
        if (aP(e)) e = e.toString();
        if (dC(e)) return b(e).length === 0;
        if (bh(e)) {
            for (var c in e) {
    ...
    var dH = function() {
        ...
        if (eF(e)) return "ios";
        if (aJ(e)) return "android";
        if (ai(e)) return "mobile";
        return false
    };
    var eV = function(e) {
        var c;
    ...
    V.on("click",
        function() {
            ...
            if (c) {
                ...
                a.addClass("hidden");
                a.filter("#" + c).removeClass("hidden");
                a.filter("#" + c).find(".s").trigger("focusin")
            }
        });
    a.find(".s").on("focusin",
        function() {
...
(function(e, c, d) {
    ...
    function ad(V, ad) {
        ...
        var b = e(V),
            f;
        b.on("tooltip:show " + ad.trigger.show,
            function() {
        ...
        b.on("tooltip:hide " + ad.trigger.hide,
            function() {
                ...
                f = setTimeout(function() {
                        ...
                        if (ad.fade) {
                            d.stop().fadeTo(ad.fade.duration, 0,
                                function() {
                                    d.remove();
                                    if (ad.fade.complete) {
    ...
    function(e, c) { !
        function() {
            for (var e = 0,
                     d = ["ms", "moz", "webkit", "o"], V = 0; V < d.length && !c.requestAnimationFrame; ++V) c.requestAnimationFrame = c[d[V] + "RequestAnimationFrame"],
