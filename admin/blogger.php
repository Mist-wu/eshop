...
if (empty($action)) {
    ...
    $br = '<a href="./">控制台</a><a href="./setting.php">系统管理</a><a><cite>个人信息</cite></a>';

    include View::getAdmView(User::haveEditPermission() ? 'header' : 'uc_header');
    require_once(View::getAdmView('templates/default/blogger/index'));
...
if($action == 'reset_password'){
    ...
    require_once(View::getAdmView('templates/default/blogger/reset_pwd'));
